...
// import register from "assets/img/profile cover.png";
// import login from "assets/img/profile cover.pngg";
// import lock from "assets/img/lock.jpeg";
// import error from "assets/img/clint-mckoy.jpg";
// import pricing from "assets/img/profile cover.png";
...
export default function Pages(props) {
  ...
  return (
    <div className={classes.bgColorWhite}>
      {/* <AuthNavbar brandText={getActiveRoute(routes)} {...rest} /> */}
      <img src= {logo}  className={classes.logoImage} onClick={() => {
